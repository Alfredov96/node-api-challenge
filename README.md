...
`express is like react for backend, Express sits on top of the raw http server module provided by Node.js and adds extra functionality, like routing and middleware support, and a simpler API.`
...
`the success of the API call or a status code(200)`
